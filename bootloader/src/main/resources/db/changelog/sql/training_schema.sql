...
(
    ...
    FOREIGN KEY (training_plan_id)
        REFERENCES training.training_plan (id)
);
...
(
    ...
    FOREIGN KEY (exercise_id)
        REFERENCES training.exercise (id)
);
...
(
    ...
    FOREIGN KEY (training_plan_exercise_id)
        REFERENCES training.training_plan_exercise (id),
    FOREIGN KEY (training_id)
        REFERENCES training.training_entry (id)
);
