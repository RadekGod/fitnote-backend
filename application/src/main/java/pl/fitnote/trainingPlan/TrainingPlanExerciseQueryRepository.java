...
//    Optional<SimpleTrainingPlanExerciseProjection> findTrainingPlanExerciseOfGivenTrainingPlan(@Param("trainingPlanExerciseId") Long trainingPlanExerciseId, @Param("email") String email);
    Optional<SimpleTrainingPlanExerciseProjection> findByIdAndTrainingPlanIdAndTrainingPlanUserEmailOrderByIdAsc(@Param("trainingPlanExerciseId") Long trainingPlanExerciseId, @Param("trainingPlanId") Long trainingPlanId, @Param("email") String email);
    ...
    Optional<TrainingPlanExercise> findByIdAndTrainingPlanIdAndTrainingPlanUserEmail(@Param("trainingPlanExerciseId") Long trainingPlanExerciseId, @Param("trainingPlanId") Long trainingPlanId, @Param("email") String email);
}
